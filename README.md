...
<a href="https://kn0tzer.is-a.dev/test">/test</a>

<a href="https://kn0tzer.is-a.dev/test">/devices</a> - Select a device to run in your browser and choose between a fake device that just simulates the UI, a real device that can do anything, or a remote desktop system.