...
class OceanMaterial extends entity.Component {
	...
	Init(params) {
		...
		const noiseTexture = loader.load("./Background/resources/textures/simplex-noise.png");
		const testTexture = loader.load("./Background/resources/textures/uv_grid_opengl.jpg");



		const cubeTextureLoader = new THREE.CubeTextureLoader();
		cubeTextureLoader.setPath('./Background/resources/textures/cube/sky/');
