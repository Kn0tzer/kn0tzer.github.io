...
class Main extends entity.Entity{
	...
	async LoadControllers() {
		...
		// Fixed camera position and rotation for portfolio background
		// Camera sits just above the water looking toward the horizon/sunrise
		this.camera.position.set(0, 5, 0);
		this.camera.rotation.set(0, 0, 0);

		// Look toward the sunrise on the horizon
		const lookTarget = new THREE.Vector3(100000, 2, 100000);
		...
		// No player/spawner — camera is fixed for portfolio background
